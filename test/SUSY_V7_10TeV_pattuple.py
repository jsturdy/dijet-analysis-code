...
addDefaultSUSYPAT(process,True,'HLT','Summer09','31x')
...
process.TFileService = cms.Service("TFileService",
    fileName = cms.string(
        "10TeV_PATtified.root"
      )
)
# source
process.source = cms.Source("PoolSource",
                            fileNames = cms.untracked.vstring(
    '/store/mc/Summer09/LM0/GEN-SIM-RECO/MC_31X_V3-v1/0005/00FFD6DF-8DBD-DE11-893D-001F29C9C5CE.root'
    )
                            )
