void analysisPlots()
{
  ...
  //filenames[0]  = "ZJets";
  //filenames[1]  = "ZJetsMuons";
  //filenames[2]  = "ZInvisibleJets";
  filenames[0]  = "AK5_MET_350_SUSY_LM0";
  filenames[1]  = "AK5_MET_350_SUSY_LM1";
  //filenames[2]  = "SUSY_LM5";
  filenames[2]  = "AK5_MET_350_SM_Background";
  //filenames[4]  = "LQtoCMu_M250_FastSim";
  //filenames[5]  = "LQtoCMu_M400_FastSim";
  //filenames[3]  = "QCD_Background";
  //filenames[4]  = "VectorBoson_Background";
  //filenames[5]  = "TTJets";  
  //filenames[6]  = "LQtoCMu_M250_FullSim";
  //filenames[7]  = "LQtoCMu_M400_FullSim";
  //filenames[8]  = "LQtoCMu_M400";
  //filenames[9]  = "LQtoCMu_M500";
  //filenames[10] = "LQtoCMu_M600";
  //filenames[11] = "LQtoCMu_M650";
  //filenames[12] = "LQtoCMu_M700";
  //filenames[13] = "LQtoCMu_M800";
  //filenames[14] = "LQtoCMu_M900";
  //filenames[15] = "LQtoCMu_M1000";
  //filenames[16] = "LQtoCMu_M1200";
  //filenames[17] = "LQtoCMu_M1500";
  ...
  //linecolor[4] = kBlue+3;//LQ to CMu M250
  ...
  cout<<"here is 7"<<endl;
  for (int j = 0; j < NUMFILES; j++) {
    leg->AddEntry(hist[j][0][0], filenames[j],"l");
