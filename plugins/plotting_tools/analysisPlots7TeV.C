void analysisPlots7TeV(std::string mettype="CaloMET", std::string jettype="CaloJets", std::string energy="7TeV")
{
  ...
  //filenames[2]  = "SM_Background";
  //filenames[3]  = "LQtoCMu_M300";
  //filenames[4]  = "LQtoCMu_M400";
